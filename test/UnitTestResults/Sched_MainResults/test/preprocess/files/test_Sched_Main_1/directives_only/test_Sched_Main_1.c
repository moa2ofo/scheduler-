...
/**
    * @file test/unitTest/TEST_Sched_Main/test/test_Sched_Main.c
    * @brief Unit tests for Sched_Main.
    *
    * @anchor UT_Sched_Main
    *
    * @details
...
# 14 "utExecutionAndResults/utUnderTest/test/test_Sched_Main_1.c" 2
...
# 16 "utExecutionAndResults/utUnderTest/test/test_Sched_Main_1.c" 2
