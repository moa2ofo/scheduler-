...
# 12 "utExecutionAndResults/utUnderTest/test/test_Sched_EntrySequence_1.c"
...
# 70 "utExecutionAndResults/utUnderTest/src/Sched_Cfg.h"
...
# 52 "utExecutionAndResults/utUnderTest/src/Sched_EntrySequence.h"
...
void CountTime_CMockExpect(UNITY_UINT cmock_line);
...
void ExecutePendingTasks_CMockExpect(UNITY_UINT cmock_line);
...
void DeltaTime_u32_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint32_t cmock_to_return);

void DeltaTime_u32_CMockStopIgnore(void);


void DeltaTime_u32_CMockExpectAndReturn(UNITY_UINT cmock_line, uint32_t cmock_to_return);
...
void Sched_Task0_CMockExpect(UNITY_UINT cmock_line);
...
# 122 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Sched_EntrySequence_1/mock_Sched_Priv.h"
#pragma GCC diagnostic pop
...
# 86 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Sched_EntrySequence_1/mock_Mcu.h"
#pragma GCC diagnostic pop
