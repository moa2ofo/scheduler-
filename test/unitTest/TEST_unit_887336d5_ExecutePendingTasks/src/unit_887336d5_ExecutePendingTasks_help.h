#ifndef TEST_UNIT_887336D5_EXECUTEPENDINGTASKS_HELP_H
#define TEST_UNIT_887336D5_EXECUTEPENDINGTASKS_HELP_H

#include "unit_887336d5_ExecutePendingTasks.h"
#include <stddef.h>
#include <string.h>
...
const Task_t* get_Task_ac_ptr(void) { return Task_ac; }
size_t get_Task_ac_size(void) { return 0U; }

static uint32_t Timer_u32 = 0u;
uint32_t get_Timer_u32(void) { return Timer_u32; }
void set_Timer_u32(uint32_t val) { Timer_u32 = val; }

#endif /* TEST_UNIT_887336D5_EXECUTEPENDINGTASKS_HELP_H */
